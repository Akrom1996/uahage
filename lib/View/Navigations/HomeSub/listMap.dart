...
import 'package:uahage/View/Navigations/HomeSub/listSub/listSub.dart';
...
class _map_listState extends State<map_list> {
  ...
  Future searchCategory() async {
    controller.loadUrl(url +
        "/maps/show-place?lat=$latitude&lon=$longitude&type=filter&user_id=${userId}&menu=${grey_image[0]}&bed=${grey_image[1]}&tableware=${grey_image[2]}&meetingroom=${grey_image[3]}&diapers=${grey_image[4]}&playroom=${grey_image[5]}&carriage=${grey_image[6]}&nursingroom=${grey_image[7]}&chair=${grey_image[8]}");
  }
            ...
            children: [
              WebView(
                ...
                onWebViewCreated: (WebViewController webViewController) {
                  ...
                  controller.loadUrl(url +
                      '/maps/show-place?lat=$latitude&lon=$longitude&type=allsearch&place_code=$place_code');
